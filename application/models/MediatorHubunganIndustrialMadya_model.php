...
class MediatorHubunganIndustrialMadya_model extends CI_Model
{
    ...
    public function tambah()
    {
        ...
        $data =  [
            ...
            "status2" => $this->input->post('status2', true) !== null ? htmlspecialchars($this->input->post('status2', true)) : 'Proses',
            ...
            "catatan2" => $this->input->post('catatan', true) !== null ? htmlspecialchars($this->input->post('catatan2', true)) : ''
        ];
