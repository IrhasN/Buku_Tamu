...
$user = [
    'role_id' => 'PengawasKoperasiMadya', // Gantilah dengan nilai yang sesuai
...
<?php if (isset($user['role_id']) && $user['role_id'] == $PengawasKoperasiMadya) : ?>
    <?php $judul = 'Halaman PengawasKoperasiMadya'; ?>
    <?php if ($title == $judul) : ?>
    ...
    <a class="nav-link" href="<?= base_url('PengawasKoperasiMadya'); ?>">
...
$op = 'Halaman Operator';
$sk = 'Halaman PengawasKoperasiMadya';
?>
...
<li class="<?= ($title == $sk) ? 'nav-item active' : 'nav-item'; ?>">
    <!-- Isi dengan konten item navigasi sesuai kebutuhan -->
                ...
                <?php if ($title == $judul) : ?>
                    ...
                    <a class="nav-link" href="<?= base_url('PengawasKoperasiMadya/BKPengawasKoperasiMadya'); ?>">
