           ...
           <div class="col-lg-9">
               ...
               <div class="card shadow mb-4">
                   ...
                   <div class="card-body">
                       ...
                       <a href="<?= base_url('data_tujuan/tambah'); ?>" class="btn btn-info btn-icon-split mb-4">
                       ...
                       <div class="table-responsive">
                           <table class="table table-bordered table-hover" id="dataTujuan" width="100%" cellspacing="0">
                               <thead>
                                   <tr>
                                       <th>No.</th>
                                       <th>Data Tujuan</th>
                               ...
                               <tbody>
                                   ...
                                   <?php foreach ($data_tujuan as $dt) : ?>
                                       <tr>
                                           ...
                                           <td><?= $dt['tujuan']; ?></td>
                                           <td>
                                               <a href="<?= base_url('data_tujuan/delete/'); ?><?= $dt['id']; ?>">
                                               ...
                                               <a href="<?= base_url('data_tujuan/edit/'); ?><?= $dt['id']; ?>">
