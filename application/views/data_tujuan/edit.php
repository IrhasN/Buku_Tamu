       ...
       <div class="container-fluid">
           ...
           <div class="card shadow mb-4">
               ...
               <div class="card-body">
                   ...
                   <form action="<?= base_url('data_tujuan/edit/'); ?><?= $data_tujuan['id']; ?>" method="POST">
                       <input type="hidden" name="id" value="<?= $data_tujuan['id']; ?>">
                       <div class="form-group">
                           <label for="tujuan">Kategori Data Tujuan</label>
                           <input type="text" class="form-control" name="tujuan" id="tujuan" value="<?= $data_tujuan['tujuan']; ?>">
