   ...
   <div class="container-fluid">
       ...
       <div class="card shadow mb-4">
           ...
           <div class="card-body">
               ...
               <a href="<?= base_url('daftar_tamu/tambah'); ?>" class="btn btn-info btn-icon-split mb-4">
            ...
            <?php foreach ($daftar_tamu as $bk) : ?>
                ...
                <?php if (!$is_more_than_one_day) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('daftar_tamu/edit/') . $bk['id']; ?>">
                                <span class="badge badge-primary"><i class="fas fa-eye"></i> Lihat</span>
                            </a>
                        </td>
                        <td>
                        <?php
...
// Logika untuk menentukan status1
if ($status1 == 'Diterima') {
