           ...
           <div class="col-lg-9">
               ...
               <div class="card shadow mb-4">
                   ...
                   <div class="card-body">
                       ...
                       <a href="<?= base_url('data_keperluan/tambah'); ?>" class="btn btn-info btn-icon-split mb-4">
                       ...
                       <div class="table-responsive">
                           <table class="table table-bordered table-hover" id="keperluan" width="100%" cellspacing="0">
                               <thead>
                                   <tr>
                                       <th>No.</th>
                               ...
                               <tbody>
                                   <?php $i = 1; ?>
                                   <?php foreach ($data_keperluan as $dt) : ?>
                                       <tr>
                                           <td><?= $i; ?></td>
                                           <td><?= $dt['keperluan']; ?></td>
                                           <td>
                                               <a href="<?= base_url('data_keperluan/delete/'); ?><?= $dt['id']; ?>">
                                               ...
                                               <a href="<?= base_url('data_keperluan/edit/'); ?><?= $dt['id']; ?>">
