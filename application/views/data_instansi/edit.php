       ...
       <div class="container-fluid">
           ...
           <div class="card shadow mb-4">
               ...
               <div class="card-body">
                   ...
                   <form action="<?= base_url('data_instansi/edit/'); ?><?= $data_instansi['id']; ?>" method="POST">
                       <input type="hidden" name="id" value="<?= $data_instansi['id']; ?>">
                       <div class="form-group">
                           <label for="instansi">Kategori Data instansi</label>
                           <input type="text" class="form-control" name="instansi" id="instansi" value="<?= $data_instansi['instansi']; ?>">
