...
$user = [
    'role_id' => 'KepalaSubBagianPerencaan', // Gantilah dengan nilai yang sesuai
...
<?php if (isset($user['role_id']) && $user['role_id'] == $KepalaSubBagianPerencaan) : ?>
    <?php $judul = 'Halaman KepalaSubBagianPerencaan'; ?>
    <?php if ($title == $judul) : ?>
    ...
    <a class="nav-link" href="<?= base_url('KepalaSubBagianPerencaan'); ?>">
...
$op = 'Halaman Operator';
$sk = 'Halaman KepalaSubBagianPerencaan';
?>
...
<li class="<?= ($title == $sk) ? 'nav-item active' : 'nav-item'; ?>">
    <!-- Isi dengan konten item navigasi sesuai kebutuhan -->
                ...
                <?php if ($title == $judul) : ?>
                    ...
                    <a class="nav-link" href="<?= base_url('KepalaSubBagianPerencaan/BKKepalaSubBagianPerencaan'); ?>">
