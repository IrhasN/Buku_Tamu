                   ...
                   <ul class="list-group">
                       <?php foreach ($tujuan as $row) : ?>
                           <li class="list-group-item d-flex justify-content-between align-items-center">
                               <?= $row['tujuan']; ?>
                               <?php if ($row['id'] == 1) : ?>
                                   <span class="badge badge-primary badge-pill"><?= $total_kakanwil; ?></span>
                               <?php elseif ($row['id'] == 2) : ?>
                                   <span class="badge badge-primary badge-pill"><?= $total_kabag; ?></span>
                               <?php elseif ($row['id'] == 3) : ?>
                                   <span class="badge badge-primary badge-pill"><?= $total_bimas; ?></span>
                               <?php elseif ($row['id'] == 4) : ?>
                                   <span class="badge badge-primary badge-pill"><?= $total_kristen; ?></span>
                               <?php elseif ($row['id'] == 5) : ?>
                                   <span class="badge badge-primary badge-pill"><?= $total_P_kristen; ?></span>
                               <?php elseif ($row['id'] == 6) : ?>
                                   <span class="badge badge-primary badge-pill"><?= $total_katolik; ?></span>
                               <?php elseif ($row['id'] == 7) : ?>
                                   <span class="badge badge-primary badge-pill"><?= $total_hindu; ?></span>
                               <?php elseif ($row['id'] == 8) : ?>
                                   <span class="badge badge-primary badge-pill"><?= $total_buddha; ?></span>
                               <?php elseif ($row['id'] == 9) : ?>
                                   <span class="badge badge-primary badge-pill"><?= $total_phu; ?></span>
                               <?php elseif ($row['id'] == 12) : ?>
                                   <span class="badge badge-primary badge-pill"><?= $total_pendis; ?></span>
                               <?php elseif ($row['id'] == 16) : ?>
                                   <span class="badge badge-primary badge-pill"><?= $total_kepeg; ?></span>
                               <?php elseif ($row['id'] == 17) : ?>
                                   <span class="badge badge-primary badge-pill"><?= $total_perencana; ?></span>
                               <?php elseif ($row['id'] == 18) : ?>
                                   <span class="badge badge-primary badge-pill"><?= $total_umum; ?></span>
                               <?php elseif ($row['id'] == 19) : ?>
                                   <span class="badge badge-primary badge-pill"><?= $total_humas; ?></span>
                               <?php elseif ($row['id'] == 20) : ?>
                                   <span class="badge badge-primary badge-pill"><?= $total_ortala; ?></span>
                               <?php elseif ($row['id'] == 21) : ?>
                                   <span class="badge badge-primary badge-pill"><?= $total_prakom; ?></span>
                               <?php endif; ?>
                           </li>
                       <?php endforeach; ?>
                   </ul>
