...
$user = [
    'role_id' => 'KepalaBidangUsahaMikro', // Gantilah dengan nilai yang sesuai
...
<?php if (isset($user['role_id']) && $user['role_id'] == $KepalaBidangUsahaMikro) : ?>
    <?php $judul = 'Halaman KepalaBidangUsahaMikro'; ?>
    <?php if ($title == $judul) : ?>
    ...
    <a class="nav-link" href="<?= base_url('KepalaBidangUsahaMikro'); ?>">
...
$op = 'Halaman Operator';
$sk = 'Halaman KepalaBidangUsahaMikro';
?>
...
<li class="<?= ($title == $sk) ? 'nav-item active' : 'nav-item'; ?>">
    <!-- Isi dengan konten item navigasi sesuai kebutuhan -->
                ...
                <?php if ($title == $judul) : ?>
                    ...
                    <a class="nav-link" href="<?= base_url('KepalaBidangUsahaMikro/BKKepalaBidangUsahaMikro'); ?>">
