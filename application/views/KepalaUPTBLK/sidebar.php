...
$user = [
    'role_id' => 'KepalaUPTBLK', // Gantilah dengan nilai yang sesuai
...
<?php if (isset($user['role_id']) && $user['role_id'] == $KepalaUPTBLK) : ?>
    <?php $judul = 'Halaman KepalaUPTBLK'; ?>
    <?php if ($title == $judul) : ?>
    ...
    <a class="nav-link" href="<?= base_url('KepalaUPTBLK'); ?>">
...
<li class="<?= ($title == $sk) ? 'nav-item active' : 'nav-item'; ?>">
    <!-- Isi dengan konten item navigasi sesuai kebutuhan -->
                ...
                <?php if ($title == $judul) : ?>
                    ...
                    <a class="nav-link" href="<?= base_url('KepalaUPTBLK/BKKepalaUPTBLK'); ?>">
