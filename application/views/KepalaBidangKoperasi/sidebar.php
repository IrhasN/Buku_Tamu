...
$user = [
    'role_id' => 'KepalaBidangKoperasi', // Gantilah dengan nilai yang sesuai
...
<?php if (isset($user['role_id']) && $user['role_id'] == $KepalaBidangKoperasi) : ?>
    <?php $judul = 'Halaman KepalaBidangKoperasi'; ?>
    <?php if ($title == $judul) : ?>
    ...
    <a class="nav-link" href="<?= base_url('KepalaBidangKoperasi'); ?>">
...
$op = 'Halaman Operator';
$sk = 'Halaman KepalaBidangKoperasi';
?>
...
<li class="<?= ($title == $sk) ? 'nav-item active' : 'nav-item'; ?>">
    <!-- Isi dengan konten item navigasi sesuai kebutuhan -->
                ...
                <?php if ($title == $judul) : ?>
                    ...
                    <a class="nav-link" href="<?= base_url('KepalaBidangKoperasi/BKKepalaBidangKoperasi'); ?>">
