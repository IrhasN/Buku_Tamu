...
$user = [
    'role_id' => 'IntrukturMuda', // Gantilah dengan nilai yang sesuai
...
<?php if (isset($user['role_id']) && $user['role_id'] == $IntrukturMuda) : ?>
    <?php $judul = 'Halaman IntrukturMuda'; ?>
    <?php if ($title == $judul) : ?>
    ...
    <a class="nav-link" href="<?= base_url('IntrukturMuda'); ?>">
...
<li class="<?= ($title == $sk) ? 'nav-item active' : 'nav-item'; ?>">
    <!-- Isi dengan konten item navigasi sesuai kebutuhan -->
                ...
                <?php if ($title == $judul) : ?>
                    ...
                    <a class="nav-link" href="<?= base_url('IntrukturMuda/BKIntrukturMuda'); ?>">
