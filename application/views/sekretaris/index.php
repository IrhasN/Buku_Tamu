       ...
       <div class="container-fluid">
           ...
           <div class="card-header py-3">
               <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-book"></i> Antrian Data Buku Tamu</h6>
           </div>
           <div class="card-body">
            ...
            <?php foreach ($sekretaris as $bk) : ?>
                ...
                <?php if (!$is_more_than_one_day && empty($bk['status1'])) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('sekretaris/edit/') . $bk['id']; ?>">
