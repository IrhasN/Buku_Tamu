...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
               <div class="card-header py-3">
                   <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-book"></i> <?= $title; ?> : <?= $sekretaris['nama']; ?></h6>
               </div>
        <div class="card mb-4 py-3 border-left-primary">
            <div class="card-body">
            <form action="<?= base_url('sekretaris/edit/'); ?><?= $sekretaris['id']; ?>" method="POST">
                ...
                <tbody>
                               ...
                               <tr>
                                   ...
                                   <?php foreach ($instansi as $in) : ?>
                                           <?php if ($in['id'] == $sekretaris['id_instansi']) : ?>
                               ...
                               <tr>
                                   ...
                                   <td>
                                       ...
                                       <?php foreach ($tujuan as $tj) : ?>
                                           <?php if ($tj['id'] == $sekretaris['id_tujuan']) : ?>
                                   ...
                                   <?php foreach ($keperluan as $kp) : ?>
                                           <?php if ($kp['id'] == $sekretaris['id_keperluan']) : ?>
                               ...
                               <tr>
                                   <td>Telp : </td>
                                   <td><?= $sekretaris['telp']; ?> </td>
                               </tr>
                               <tr>
                                   <td>Tanggal Tiba : </td>
                                   <td><?= $sekretaris['waktu']; ?> Wita.</td>
                               </tr>
                               <tr>
                                   <td>Keterangan : </td>
                                   <td><?= $sekretaris['keterangan']; ?></td>

                    
                            
                        <tr> <td>Catatan :</td>
                            <td>
                                <input type="text" class="form-control" name="catatan1" value="<?= $sekretaris['catatan1']; ?>">
                            </td></tr>
                ...
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control" name="layanan" id="status1" value="<?= $sekretaris['status1']; ?>">
                </div>
