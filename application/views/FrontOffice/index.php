       ...
       <div class="container-fluid">
           ...
           <div class="card shadow mb-4">
               <div class="card-header py-3">
                   <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-chart-pie"></i> Antrian Tamu</h6>
               </div>
               <div class="card-body">
 ...
 <?php endforeach; ?>
           ...
           <div class="card shadow mb-4">
               ...
               <div class="card-body">
                   ...
                   <ul class="list-group">
                       <?php foreach ($tujuan as $row) : ?>
                           <li class="list-group-item d-flex justify-content-between align-items-center">
                               ...
                               <?php elseif ($row['id'] == 7) : ?>
                                   <span class="badge badge-primary badge-pill"><?= $total_Sekretaris; ?></span>
                               <?php elseif ($row['id'] == 8) : ?>
                   ...
                   <h5> <a href="<?= base_url('kategori_tamu'); ?>" class="badge badge-primary mt-3"> <i class="fas fa-list-alt"></i> Kategori Tamu</a> </h5>
